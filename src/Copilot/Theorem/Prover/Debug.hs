{- As part of a huge hack, this is a copy of the debug backend from
 - https://github.com/hguenther/smtlib2/ from the smtlib2-debug package,
 - author: Henning Günther. -}
{- Only change (chathhorn): this version exposes its internals. -}
{-# LANGUAGE PolyKinds,DataKinds,ScopedTypeVariables #-}
{-# LANGUAGE FlexibleContexts,TypeFamilies,GADTs,ExistentialQuantification,OverloadedStrings,DeriveDataTypeable,GeneralizedNewtypeDeriving,StandaloneDeriving,FlexibleInstances #-}
module Copilot.Theorem.Prover.Debug where
